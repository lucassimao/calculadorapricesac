...
| `premium_paywall_viewed`                       | estado da loja sem origem                                         | `source` obrigatório, `nth_view` + estado da loja                                                                                             | estender                                    |
| `premium_status_viewed`                        | estado da loja                                                    | igual                                                                                                                                         | manter                                      |
...
| `purchase_started`                             | disparava antes das precondições; contexto sem tentativa          | contexto + `attempt_id`, `nth_view`, somente após conexão/produto                                                                             | corrigir                                    |
| `purchase_success`                             | contexto sem tentativa                                            | contexto + `attempt_id`; terminal único                                                                                                       | corrigir                                    |
| `purchase_cancelled`                           | misturado em failed                                               | contexto + `attempt_id`; código SDK `user-cancelled`                                                                                          | adicionar                                   |
| `purchase_failed`                              | sem código nem dedupe                                             | contexto + `attempt_id`, `error_code`; terminal único                                                                                         | corrigir                                    |

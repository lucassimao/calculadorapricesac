...
| `rewarded_export_ad_failed`                    | `error_message` livre                                             | manter `error_message`; `error_kind` normalizado (`no_fill`, `load_timeout`, `network`, `unknown`) + `error_code` exato do SDK quando disponível | estender                                    |
